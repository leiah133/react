      ...
      <div className='w-full min-h-screen flex flex-wrap  items-center justify-center bg-indigo-50'>
        <div className='w-96 bg-gradient-to-r from-cyan-300  via-pink-200 to-sky-300 rounded-3xl pt-[90px] px-[55px] pb-[53px] shadow-2xl'>
          ...
          <form className='w-full'>
            <h1 className='block text-3xl text-black leading-10 text-center mb-3'>Registre-se</h1>
            ...
            <button className='text-lg border-none rounded-2xl font-semibold hover:bg-slate-400 leading-10 flex uppercase justify-center items-center w-full h-[50px] bg-fuchsia-400 cursor-pointer hover:scale-125 duration-700'><Link to="/Home">Registrar </Link></button>
            <div className='flex justify-center items-center mt-[50px]'>
              <p className='text-lg'>Possui conta? <Link to="/Login" className='text-pink-700 font-semibold'>Login</Link> </p>
            </div>
          </form>
        </div>
      </div>
